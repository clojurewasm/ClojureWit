...
(module
  ...
  (global $mix7 (mut (ref null $obj)) (ref.null $obj))
  (global $mix8 (mut (ref null $obj)) (ref.null $obj))
  (global $mix10 (mut (ref null $obj)) (ref.null $obj))
  ...
  (func $setup
    ...
    (local.set $prev (local.get $cur))
    (struct.set $node $nxt (local.get $prev) (local.get $head))
    (global.set $mix7 (local.get $head))
    ...
    (local.set $prev (local.get $cur))
    (struct.set $node $nxt (local.get $prev) (local.get $head))
    (global.set $mix8 (local.get $head))
    ...
    (local.set $prev (local.get $cur))
    (struct.set $node $nxt (local.get $prev) (local.get $head))
    (global.set $mix10 (local.get $head)))
  ...
  (func (export "b7_guarded_7") (param $n i32) (result i32)
    (call $guarded (local.get $n) (global.get $mix7)))
  (func (export "b7_generic_7") (param $n i32) (result i32)
    (call $walk (local.get $n) (global.get $mix7)))
  (func (export "b7_guarded_8") (param $n i32) (result i32)
    (call $guarded (local.get $n) (global.get $mix8)))
  (func (export "b7_generic_8") (param $n i32) (result i32)
    (call $walk (local.get $n) (global.get $mix8)))
  (func (export "b7_guarded_10") (param $n i32) (result i32)
    (call $guarded (local.get $n) (global.get $mix10)))
  (func (export "b7_generic_10") (param $n i32) (result i32)
    (call $walk (local.get $n) (global.get $mix10)))
